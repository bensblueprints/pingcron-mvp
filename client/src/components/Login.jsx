    ...
    <div className="min-h-screen grid place-items-center px-4">
      ...
      >
        <div className="flex items-center gap-2 justify-center text-lg font-semibold">
          <Activity className="w-6 h-6 text-emerald-400" /> Pingcron
        </div>
        <p className="text-sm text-zinc-500 text-center">
          Dead-man's-switch monitoring for your cron jobs. Pay once, own it forever.
        </p>
        ...
        <button
          disabled={busy}
          className="w-full bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-zinc-950 font-medium rounded-lg py-2 transition-colors"
        >
